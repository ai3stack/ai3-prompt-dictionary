...
- **(2026-06-15)** Prompt 930 open-source release readiness: README, deployment notes, support/security routing, issue templates, and a GitHub release package draft now reflect the current 930-prompt dataset release surface.

### Changed
- **(2026-06-07)** Dataset is English-only — legacy `content/zh-CN/*` removed; all npm package / scope references standardized to `@ai3stack`.
- **(2026-06-15)** Current consumer-site references now point to `dict.ai3stack.com`. The old assistant-connector / MCP package narrative is superseded for the current Prompt 930 launch surface; see `docs/DECISIONS.md` D-0006.
- **(2026-06-15)** Prompt 930 canceled MCP, browser extensions, Chrome Web Store, VS Code extensions, and plugin packaging as active product surfaces; see `docs/DECISIONS.md` D-0007.
