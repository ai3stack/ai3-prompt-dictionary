...
- **(2026-06-07)** MCP server consolidated into this repo under `mcp-server/` and published to npm as [`@ai3stack/prompts-mcp`](https://www.npmjs.com/package/@ai3stack/prompts-mcp) — `npx -y @ai3stack/prompts-mcp` plugs all 930+ prompts into any MCP client. README gained a "Use it instantly in your AI assistant (MCP)" section; `docs/DECISIONS.md` D-0001 amended to record the colocation.
